        ...
        try:
            if input_audio:
                ...
                if duration > 20 and limitation:
                    return (
                        "Please upload an audio file that is less than 20 seconds. If you need to generate a longer audio file, please use Colab.",
                        None,
                    )
    ...
    for name, info in models_info.items():
        ...
        models.append(
            (
                ...
                author,
                cover,
                create_vc_fn(tgt_sr, net_g, vc, if_f0, index, npy),
            )
        )
        break
    print(models)
